...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 30, // 更新缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.aizhp.com', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,Hi，欢迎来到我的博客🎉',
